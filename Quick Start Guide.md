...
|------|------------|--------------|
| **[/submit](http://localhost:3000/submit)** | Students (on their phones) | 3-question form: age-8 career, hidden talent, question for you |
| **[/admin](http://localhost:3000/admin)** | You (on your laptop) | Control panel — trigger synthesis, switch display states |
| **[/display](http://localhost:3000/display)** | Projector | Full-screen view that updates based on your admin controls |

> **Note:** The links above are local. During the event, students will use the public URL shown on the QR code.
...
```
This prints a public URL like `https://something-something.trycloudflare.com`. That's the URL students will use. Copy it.

### 3. Open the admin and display pages
- **On your laptop:** Open [localhost:3000/admin](http://localhost:3000/admin) — enter PIN `1234`
- **On the projector laptop/screen:** Open [localhost:3000/display](http://localhost:3000/display) — full screen it (F11 or Cmd+Shift+F in Chrome)
